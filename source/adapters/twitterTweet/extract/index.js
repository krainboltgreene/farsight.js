export default function extract (raw: RawTwitterStatusType): CuratedTwitterStatusType {
  return {
    status: {
      id: raw.id_str,
      body: raw.text,
      createdAt: new Date(raw.created_at),
      href: `https://twitter.com/${raw.user.screen_name}/status/${raw.id_str}`,
    },
    user: {
      username: raw.user.screen_name,
      src: raw.user.profile_image_url,
    },
  }
}
